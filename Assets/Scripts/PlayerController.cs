...
//MAKE ENERGY METER -> DONE, NO UI
//WEAPONS AND SHOOTING -> PARTIALLY DONE
//DRONES AND TOOLS
//FIX OPPOSITE ADAD MOVEMENT (INVERT DEACCELERATION) -> DONE
//MAKE UI
...
//PLAYER STATS
	...
	[SerializeField]
	private float reflex = 3f;  //MINIMUM SPEED FOR WASD SWITCHINGS (2 vector!)
	...
	[SerializeField]
	private Vector2 lookSensitivity = Vector2.zero; //TAKE FROM MASS, LEFT AND RIGHT ARM DIFFERENT
